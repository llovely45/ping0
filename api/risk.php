...
'>(说明?)</a>
                    ...
                    <div class="content">
                                                <span class="label orange">IDC机房IP</span>
                                                <span class="label red">代理IP</span>
...
请查看 CentOS 的 /var/log/secure 文件或者 Debian 的 journalctl -u ssh.service 的内容，这里都是一些尝试爆破你SSH密码的风险IP。">(说明?)</a>
                    ...
                    <div class="content">
                        <div class="riskbar" style="display: flex;justify-content: center;align-items: center;">
                                                        <div class="riskitem" style="background:green" title="0-15 极度纯净"></div>
                                                        ...
                                                        <div class="riskitem riskcurrent" style="background:red" title="70-100 极度风险"><span class="value">100%</span><span class="lab"> 极度风险</span></div>
                                                    </div>
                    </div>
                </div>
...
当一个 IP 显示 为广播 IP 时，通常代表这是一个 非家庭宽带 IP，非本地 IDC 提供商 IP。">(说明?)</a>
                    ...
                    <div class="content">
                                                <span class="label orange" style="background: #f00">垃圾 IP</span>
                                            </div>
                </div>
                ...
                <div class="line ipnum" style="margin:0 -1px 0 -1px;">
                    ...
                    <div class="content">
                        <div class="usecountbar" usecount="10000+ (极度风险)" title="1-10(极好), 10-100(一般), 100-1000(风险), 1000-10000(高危), 10000+(极度风险)">
                        10000+ (极度风险)                        </div>
                    </div>
                </div>
                            </div>
...
<script type="text/javascript">
    ...
    window.tar= ''
    window.ipnum = '<?php echo $ip2Number; ?>'
